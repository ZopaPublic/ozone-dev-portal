...
def make_registration_jwt(software_statement_id: str, kid: str, software_statement: str) -> str:
    ...
    claims = dict(
        ...
        scope= "openid accounts",   #accounts for AISP
        request_object_signing_alg="none",
        exp=jwt_exp,
        iat=jwt_iat,
        jti=str(uuid.uuid4()),
...
response = requests.post("https://ob-api1.openbanking-sandbox.zopa.com/dynamic-client-registration/v3.1/register",
...
```
Endpoint: https://ob-api1.openbanking-sandbox.zopa.com/ozone/v1.0/postman/environment
